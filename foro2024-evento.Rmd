...
mypal <- colorBin(palette = "Blues", domain = admin$count, na.color = "#bbbbbb", bins = c(1,3,10,30,Inf))
...
leaflet(admin, options = leafletOptions(minZoom = 6, maxZoom = 10)) %>%
  ...
  addLegend(pal = mypal, values = ~count, opacity = 1, title = "No. asistentes", position = "bottomright")
```
